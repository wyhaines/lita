module Lita
  class HttpRouter
    class Node
      autoload :Root,                'lita/lita_http_router/node/root'
      autoload :Glob,                'lita/lita_http_router/node/glob'
      autoload :GlobRegex,           'lita/lita_http_router/node/glob_regex'
      autoload :Variable,            'lita/lita_http_router/node/variable'
      autoload :Regex,               'lita/lita_http_router/node/regex'
      autoload :SpanningRegex,       'lita/lita_http_router/node/spanning_regex'
      autoload :GlobRegex,           'lita/lita_http_router/node/glob_regex'
      autoload :FreeRegex,           'lita/lita_http_router/node/free_regex'
      autoload :AbstractRequestNode, 'lita/lita_http_router/node/abstract_request_node'
      autoload :Host,                'lita/lita_http_router/node/host'
      autoload :UserAgent,           'lita/lita_http_router/node/user_agent'
      autoload :RequestMethod,       'lita/lita_http_router/node/request_method'
      autoload :Scheme,              'lita/lita_http_router/node/scheme'
      autoload :Lookup,              'lita/lita_http_router/node/lookup'
      autoload :Path,                'lita/lita_http_router/node/path'
